...
#   Generated: Fri Mar 25 20:35:18 2022
...
#  First the compiler
if [ "$COMPILER" != "native" ] && [ -e /cvmfs/sft.cern.ch/lcg/releases/gcc/11.2.0/x86_64-centos7/setup.sh ]; then
    source /cvmfs/sft.cern.ch/lcg/releases/gcc/11.2.0/x86_64-centos7/setup.sh
fi

#  LCG version
LCG_VERSION=102rc1; export LCG_VERSION
