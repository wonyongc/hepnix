...
if [ -z $ROOTSYS ]; then
    export ROOTSYS=`dirname /cvmfs/sft.cern.ch/lcg/releases/ROOT/6.26.00-165a8/x86_64-centos7-gcc11-opt/cmake`
fi;
export Geant4_DIR=/cvmfs/sft.cern.ch/lcg/releases/Geant4/11.0.1-bbd6a/x86_64-centos7-gcc11-opt/lib64/Geant4-11.0.1;
export XERCESCINSTALL=/cvmfs/sft.cern.ch/lcg/releases/XercesC/3.2.3-714f6/x86_64-centos7-gcc11-opt;
#
...
if [ ${Geant4_DIR} ]; then
    ...
    export CLHEP_DIR=/cvmfs/sft.cern.ch/lcg/releases/clhep/2.4.5.1-ebe73/x86_64-centos7-gcc11-opt/lib/CLHEP-2.4.5.1/../../include/../;
    export CLHEP_ROOT_DIR=/cvmfs/sft.cern.ch/lcg/releases/clhep/2.4.5.1-ebe73/x86_64-centos7-gcc11-opt/lib/CLHEP-2.4.5.1/../../include/../;
    export CLHEP_INCLUDE_DIR=/cvmfs/sft.cern.ch/lcg/releases/clhep/2.4.5.1-ebe73/x86_64-centos7-gcc11-opt/lib/CLHEP-2.4.5.1/../../include;
    unset G4ENV_INIT;
    unset G4LIB_DIR;
fi;
#
